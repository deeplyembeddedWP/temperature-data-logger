...
#define TMP117_DEVICE_ID_VALUE_EXPECTED 0x0117 // Value found in the device ID register on reset 
#define TMP117_SUPPORTED_RESOLUTION 0.0078125f // Resolution of the device
